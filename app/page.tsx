...
import { Phone, Mail, Clock, MapPin, CheckCircle, Briefcase, Clock4, Handshake } from 'lucide-react';

const HomePage = () => {
  const services = [
    { title: 'Carpentry', description: 'Custom woodwork and installations',image:'/carpentry.jpg' },
    { title: 'Extensions', description: 'Expand your living space',image:'/extensions.jpg' },
    { title: 'Bathroom Builds', description: 'Modern bathroom renovations',image:'/tiling.jpg' },
    { title: 'Tiling', description: 'Professional tiling services',image:'/roof_tiling.jpg' },
    { title: 'Plastering', description: 'Smooth and durable finishes',image:'/plastering.jpeg' },
    { title: 'House Repairs', description: 'General maintenance and repairs',image:'/house_repairs.jpeg' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-32 text-center bg-gradient-to-br from-red-600 to-red-300 text-white">
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {services.map((service, index) => (
        <div 
          key={index} 
          className="group bg-white rounded-lg border border-gray-200 border-red-500 shadow-xl overflow-hidden"
        >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason, index) => (
            ...
            <div className="p-5 bg-white rounded-full border border-2 border-blue-400">
            {index==0 &&
            <Briefcase className="w-16 h-16 text-black"/>
            }
            {index==1 &&
            <Clock4 className="w-16 h-16 text-black"/>
            }
            {index==2 &&
